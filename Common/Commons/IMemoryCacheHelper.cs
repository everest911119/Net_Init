...
namespace Commons
{
    public interface IMemoryCacheHelper
    {
        ...
        /// <returns></returns>
        public TResult GetOrCreate<TResult>(string cacheKey, Func<ICacheEntry, TResult?> valueFacotry,
            int exprieSecond = 60);

        public  Task<TResult?> GetOrCreateAsync<TResult>(string cacheKey, Func<ICacheEntry, Task<TResult?>> valueFacotry,
